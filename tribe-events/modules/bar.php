...
<div id="tribe-events-bar" class="bg-1">
			...
			<div class="tribe-bar-filters">
				<div class="tribe-bar-filters-inner tribe-clearfix">
					...
					<div class="tribe-bar-submit">
						<input class="tribe-events-button tribe-no-param btn btn-default" type="submit" name="submit-bar" value="<?php printf( esc_attr__( 'Find %s', 'the-events-calendar' ), tribe_get_event_label_plural() ); ?>" />
					</div>
					<!-- .tribe-bar-submit -->
				</div>
